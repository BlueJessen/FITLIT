...
describe('Hydration', () => {
  ...
  it.skip("should be able to find a user's info", function () {
  ...
  it.skip("should be able to find how much a user drank on a certain day", function () {
    expect(hydrationRepo.findDayHydration(50,"2020/01/16")).to.equal(43)
  });
  it.skip("should be able to find how much a user drank each day for a week", function () {
    expect(hydrationRepo.findWeekHydration(49,"2020/01/22").to.equal([71, 68, 55, 52, 37, 38, 36]))
  })
